...
const CLUB_B: Club = { nombre: "+ Pádel", color: "#b45309", abbr: "+P", logoUrl: "/clubes/mas-padel.logo.png" }
...
const MOCK_CATEGORIAS: CategoriaInterclub[] = [
  ...
  },
  {
    ...
    partidos: [
      ...
      { id: "p7", pairA: "Peralta / Luna", pairB: "Campos / Bravo", resultado: "6-4", ganador: null, estado: "en_vivo", horaInicio: "14:30", sede: "Voleando" },
  ...
  },
  {
    ...
    partidos: [
      ...
      { id: "p11", pairA: "Castro / Medina", pairB: "Martín / Paz", resultado: null, ganador: null, estado: "en_vivo", horaInicio: "14:30", sede: "+Pádel" },
  ...
  },
  {
    ...
    partidos: [
      ...
      { id: "p22", pairA: "Molina / Quiroga", pairB: "Aguilar / Rojas", resultado: "6-2", ganador: null, estado: "en_vivo", horaInicio: "15:00", sede: "Voleando" },
  ...
  return (
    <div style={{ background: "#f8fafc", minHeight: "100vh", paddingBottom: 40 }}>
      ...
      <div style={{
        ...
        padding: "0 18px", background: "#ffffff", borderBottom: "1px solid #f1f5f9",
